...
const PHRASES = [
  "EMERGENCY!", "I AM IN PAIN", "NEED MEDICINE",
  "I NEED WATER", "I AM HUNGRY", "YES / CORRECT",
  "NO / STOP", "THANK YOU", "HELLO / READY",
  "I NEED REST", "WASHROOM", "I AM OK",
  "CALL FAMILY", "GOODBYE", "I AM TIRED"
];
