...
export const SenderView: React.FC<SenderViewProps> = ({ onSend, onExit, targetId, status }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background flex flex-col p-4 animate-fade-in pt-[calc(1rem+env(safe-area-inset-top))] pb-[calc(1rem+env(safe-area-inset-bottom))]">
      {/* Header */}
